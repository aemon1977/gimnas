...
if (isset($_POST['buscar'])) {
    ...
    $sql_buscar = "SELECT DNI, Nom FROM esporadics WHERE DNI LIKE '%$criterio_busqueda%' OR Nom LIKE '%$criterio_busqueda%'";
...
$sql_todos_socios = "SELECT DNI, Nom FROM esporadics"; // Cambiado a esporadics
